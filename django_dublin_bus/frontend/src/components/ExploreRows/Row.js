...
import { RowContainer, InfoWindow, PosterImg, PosterInfo, PosterText, PosterHead, RowPosters, RowHeading } from "./Row.elements";
...
function Row({ title, fetchUrl }) {
    ...
    return (
        <RowContainer>
            ...
            { selEvent && <InfoWindow >{MoreInfo(selEvent)}</InfoWindow> }
        </RowContainer>
    );
}
